// Socoban.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
                     ...
                     _In_ int       nCmdShow)
{
    ...
    // 전역 문자열을 초기화합니다.
    LoadStringW(hInstance, IDC_SOCOBAN, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_SOCOBAN));
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HWND hWnd = CreateWindowW(
       ...
       nWinPosX,            //윈도우 화면 좌표 x : 실행할 때 어느 위치에서 띄울 것인지
